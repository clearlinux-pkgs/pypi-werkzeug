...
Source0  : https://files.pythonhosted.org/packages/9f/69/83029f1f6300c5fb2471d621ab06f6ec6b3324685a2ce0f9777fd4a8b71e/werkzeug-3.1.3.tar.gz
...
%prep
%setup -q -n werkzeug-3.1.3
cd %{_builddir}/werkzeug-3.1.3
pushd ..
cp -a werkzeug-3.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731095523
