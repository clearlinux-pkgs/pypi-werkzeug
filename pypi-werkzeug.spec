...
Source0  : https://files.pythonhosted.org/packages/8c/47/75c7099c78dc207486e30cdb2b16059ca6d5c6cdcf9290f4621368bd06e4/werkzeug-3.0.0.tar.gz
...
%prep
%setup -q -n werkzeug-3.0.0
cd %{_builddir}/werkzeug-3.0.0
pushd ..
cp -a werkzeug-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696262484
