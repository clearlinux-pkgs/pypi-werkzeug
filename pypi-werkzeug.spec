...
Source0  : https://files.pythonhosted.org/packages/dc/db/598e5986e8cc1eeb14ecff2c1590dc59f95153cdb757196b0980b3ad0763/Werkzeug-2.2.0.tar.gz
...
%prep
%setup -q -n Werkzeug-2.2.0
cd %{_builddir}/Werkzeug-2.2.0
pushd ..
cp -a Werkzeug-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658765295
