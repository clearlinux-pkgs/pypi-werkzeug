...
Source0  : https://files.pythonhosted.org/packages/32/19/a92cdbd9fb795928dfca1031278ae8a7f051e78a2c057c224ad2d4cdd95e/Werkzeug-2.2.1.tar.gz
...
%prep
%setup -q -n Werkzeug-2.2.1
cd %{_builddir}/Werkzeug-2.2.1
pushd ..
cp -a Werkzeug-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658966496
