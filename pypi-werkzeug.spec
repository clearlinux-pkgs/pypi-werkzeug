...
Source0  : https://files.pythonhosted.org/packages/0f/84/00f7193d7bd88ced26cd5f868903e431054424610dc7c041bbe87d2a4d66/werkzeug-3.0.2.tar.gz
...
%prep
%setup -q -n werkzeug-3.0.2
cd %{_builddir}/werkzeug-3.0.2
pushd ..
cp -a werkzeug-3.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712002358
