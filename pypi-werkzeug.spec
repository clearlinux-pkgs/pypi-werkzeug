...
Source0  : https://files.pythonhosted.org/packages/02/51/2e0fc149e7a810d300422ab543f87f2bcf64d985eb6f1228c4efd6e4f8d4/werkzeug-3.0.3.tar.gz
...
%prep
%setup -q -n werkzeug-3.0.3
cd %{_builddir}/werkzeug-3.0.3
pushd ..
cp -a werkzeug-3.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715016785
